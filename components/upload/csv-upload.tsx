  ...
  if (state === 'preview' && parsedData) {
    return (
      <div className="space-y-4">
        ...
        {parsedData.totalRows > 5000 && (
          <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-3">
            <p className="text-sm font-medium text-yellow-800">
              ⚠️ Large file warning: This CSV has {parsedData.totalRows} rows. Processing may take a while.
            </p>
          </div>
        )}
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-muted-foreground">Maximum file size: 50MB | Maximum rows: 10,000</p>
        </div>
      </div>
    </div>
  )
