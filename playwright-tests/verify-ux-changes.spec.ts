...
test.describe('UX Improvements Verification', () => {
  test('should verify all 6 UX changes', async ({ page }) => {
    ...
    // 6. Verify buttons layout (Test and Run All)
    ...
    // 7. Scroll to bottom and take screenshot of buttons
    ...
    // 9. Verify API Access section is removed
    ...
    // 10. Take profile page screenshot
    await page.screenshot({
